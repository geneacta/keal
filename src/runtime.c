...
KEAL_FN void keal_audit_report(void) {
    ...
    fprintf(stderr, "  = note: a top-level binding lives to the end of a program and is counted here; anything else outlived its last reference, which is a cycle — `weak` on the back edge breaks one\n");
}
#endif
